							...
							<form class="form-horizontal" role="form" id="uploadForm" action="${pageContext.request.contextPath}/admin/uploadSlideShow" method="post" enctype="multipart/form-data" target="frameFile">
								<div class="step-pane active" data-step="1">
										<div class="form-group">
											...
											<div class="col-xs-12 col-sm-5">
												<span class="block input-icon input-icon-right">
													<input type="text" id="slideTitle" name="slideTitle" class="width-100" placeholder="请输入轮播图名称">
										...
										<div class="form-group"><!-- 有错误追加has-error样式 -->
											...
											<div class="col-xs-12 col-sm-5">
												<span class="block input-icon input-icon-right">
													<input type="text" id="slideUrl" name="slideUrl" class="width-100" placeholder="请输入轮播图链接">
													<i class="ace-icon fa"></i>
												</span>
											</div>
											<div class="help-block col-xs-12 col-sm-reset inline">  </div>
										...
										<div class="form-group"><!-- 成功追加has-success样式 -->
											...
											<div class="col-xs-12 col-sm-5">
												<span class="block input-icon input-icon-right">
													<input type="text" id="slideStartTime" name="slideStartTime" class="form-control" placeholder="请输入轮播图生效时间">
										...
										<div class="form-group"><!-- 有提示追加has-info样式 -->
											...
											<div class="col-xs-12 col-sm-5">
												<span class="block input-icon input-icon-right">
													<input type="text" id="slideEndTime" name="slideEndTime" class="width-100" placeholder="请输入轮播图失效时间">
													<i class="ace-icon fa fa-calendar"></i>
												</span>
											</div>
											<div class="help-block col-xs-12 col-sm-reset inline">  </div>
