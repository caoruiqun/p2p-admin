							...
							<div class="row">
								<div class="col-xs-12">
									...
									<div>
										...
										<label>
										<a class="blue" href="${pageContext.request.contextPath}/admin/toAddCreditorRights?creditorRightsType=0">
											...
											<tr role="row" class="even">
													...
													<td>
														<div class="hidden-sm hidden-xs action-buttons">
															<a class="green" href="${pageContext.request.contextPath}/admin/toEditCreditorRights?id=${creditorRights.id}&creditorRightsType=${creditorRightsType}">
																修改
															</a>
															<a class="red" href="${pageContext.request.contextPath}/admin/deleteCreditorRights?id=${creditorRights.id}&creditorRightsType=${creditorRightsType}">
																删除
															</a>
															<a class="green" href="${pageContext.request.contextPath}/admin/toAddProduct?creditorRightsId=${creditorRights.id}&productType=2">
																发布散标
															</a>
														</div>
													</td>
										...
										<c:choose>
											...
											<li class="paginate_button previous" aria-controls="dynamic-table" tabindex="0" id="dynamic-table_previous">
												<a href="${pageContext.request.contextPath}/admin/creditorRights?currentPage=${currentPage-1}">上一页</a>
											</li>
											</c:otherwise>
										</c:choose>
										<c:choose>
											<c:when test="${totalPage le 10}">
												...
												<a href="${pageContext.request.contextPath}/admin/creditorRights?currentPage=${i}">${i}</a>
												</li>
												</c:forEach>
											</c:when>
											<c:otherwise>
										...
										<c:choose>
											...
											<li class="paginate_button next" aria-controls="dynamic-table" tabindex="0" id="dynamic-table_next">
												<a href="${pageContext.request.contextPath}/admin/creditorRights?currentPage=${currentPage+1}">下一页</a>
											</li>
											</c:otherwise>
										</c:choose>
										</ul>
